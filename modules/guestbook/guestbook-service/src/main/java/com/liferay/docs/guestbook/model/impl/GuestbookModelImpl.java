...
/**
 * The base model implementation for the Guestbook service. Represents a row in the &quot;guestbook&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
...
public class GuestbookModelImpl extends BaseModelImpl<Guestbook>
	...
	public static final String TABLE_SQL_CREATE = "create table guestbook (guestbookid LONG not null primary key,groupid LONG,companyid LONG,userid LONG,username VARCHAR(75) null,createdate DATE null,modifieddate DATE null,status INTEGER,statusbyuserid LONG,statusbyusername VARCHAR(75) null,statusdate DATE null,name VARCHAR(75) null)";
	public static final String TABLE_SQL_DROP = "drop table guestbook";
	public static final String ORDER_BY_JPQL = " ORDER BY guestbook.guestbookId ASC";
	public static final String ORDER_BY_SQL = " ORDER BY guestbook.guestbookid ASC";
