...
public class EntryPersistenceImpl extends BasePersistenceImpl<Entry>
	...
	public List<Entry> filterFindByG_G(long groupId, long guestbookId,
		...
		query.append(_FINDER_COLUMN_G_G_GROUPID_2_SQL);

		query.append(_FINDER_COLUMN_G_G_GUESTBOOKID_2_SQL);
	...
	private static final String _FINDER_COLUMN_G_G_GROUPID_2_SQL = "entry.groupid = ? AND ";
	private static final String _FINDER_COLUMN_G_G_GUESTBOOKID_2 = "entry.guestbookId = ?";
	private static final String _FINDER_COLUMN_G_G_GUESTBOOKID_2_SQL = "entry.guestbookid = ?";
	...
	public EntryPersistenceImpl() {
		...
		try {
			...
			dbColumnNames.put("entryId", "entryid");
			...
			dbColumnNames.put("statusByUserId", "statusbyuserid");
			dbColumnNames.put("statusByUserName", "statusbyusername");
			dbColumnNames.put("statusDate", "statusdate");
			dbColumnNames.put("guestbookId", "guestbookid");
	...
	private static final String _FILTER_SQL_SELECT_ENTRY_WHERE = "SELECT DISTINCT {entry.*} FROM entry entry WHERE ";
	private static final String _FILTER_SQL_SELECT_ENTRY_NO_INLINE_DISTINCT_WHERE_1 =
		"SELECT {entry.*} FROM (SELECT DISTINCT entry.entryid FROM entry entry WHERE ";
	private static final String _FILTER_SQL_SELECT_ENTRY_NO_INLINE_DISTINCT_WHERE_2 =
		") TEMP_TABLE INNER JOIN entry ON TEMP_TABLE.entryid = entry.entryid";
	private static final String _FILTER_SQL_COUNT_ENTRY_WHERE = "SELECT COUNT(DISTINCT entry.entryid) AS COUNT_VALUE FROM entry entry WHERE ";
	private static final String _FILTER_ENTITY_ALIAS = "entry";
	private static final String _FILTER_ENTITY_TABLE = "entry";
	private static final String _ORDER_BY_ENTITY_ALIAS = "entry.";
	private static final String _ORDER_BY_ENTITY_TABLE = "entry.";
	...
	private static final Set<String> _badColumnNames = SetUtil.fromArray(new String[] {
				...
				"createDate", "modifiedDate", "statusByUserId",
				"statusByUserName", "statusDate", "guestbookId"
			});
}